...
class HMM:
    TRAIN_CORPUS = 'training/msr_training.utf8'
    TRAIN_CORPUS = 'training/pku_training.utf8'
    punctuations = set('，‘’“”。！？：（）、')
    MIN_FLOAT = -1e10
    emission = None
    transition = None
    ...
    def train(cls) -> (dict, list):
        ...
        if os.path.exists('emit_p.pickle') and os.path.exists('trans.pickle'):
...
texts += [
    '好的，现在我们尝试一下带标点符号的分词效果。', '中华人民共和国不可分割，坚决捍卫我国领土。', '英国白金汉宫发表声明，菲利浦亲王去世。', '扬帆远东做与中国合作的先行'
]
